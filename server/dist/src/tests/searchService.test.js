...
describe("SearchService", () => {
    ...
    test("returns only the top commented posts for most commented queries", () => __awaiter(void 0, void 0, void 0, function* () {
        const senderID = new mongoose_1.default.Types.ObjectId();
        const topPost = yield postsModel_1.default.create({
        ...
        const lowerPost = yield postsModel_1.default.create({
        ...
        yield commentsModel_1.default.create([
            { postID: topPost._id, userID: new mongoose_1.default.Types.ObjectId(), content: "1" },
            { postID: topPost._id, userID: new mongoose_1.default.Types.ObjectId(), content: "2" },
            { postID: topPost._id, userID: new mongoose_1.default.Types.ObjectId(), content: "3" },
            { postID: lowerPost._id, userID: new mongoose_1.default.Types.ObjectId(), content: "only one" },
        ]);
        llmResponseText = JSON.stringify({
            postIds: [lowerPost._id.toString(), topPost._id.toString()],
        });
        const service = new searchService_1.SearchService(postsModel_1.default, new llmService_1.LlmService());
        const result = yield service.searchPostsAi("give me the most commented posts", 1, 10);
        expect(result.source).toBe("fallback");
        expect(result.total).toBe(1);
        expect(result.posts[0]._id.toString()).toBe(topPost._id.toString());
    }));
    test("returns all posts that satisfy at least 2 likes", () => __awaiter(void 0, void 0, void 0, function* () {
        const senderID = new mongoose_1.default.Types.ObjectId();
        const firstMatching = yield postsModel_1.default.create({
        ...
        const secondMatching = yield postsModel_1.default.create({
        ...
        const nonMatching = yield postsModel_1.default.create({
        ...
        yield likesModel_1.default.create([
            { postID: firstMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
            { postID: firstMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
            { postID: secondMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
            { postID: secondMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
            { postID: secondMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
            { postID: nonMatching._id, senderID: new mongoose_1.default.Types.ObjectId() },
        ]);
        llmResponseText = JSON.stringify({
            postIds: [secondMatching._id.toString()],
        });
        const service = new searchService_1.SearchService(postsModel_1.default, new llmService_1.LlmService());
        const result = yield service.searchPostsAi("posts that have at least 2 likes", 1, 10);
        expect(result.source).toBe("fallback");
        expect(result.total).toBe(2);
    ...
    test("returns quoted single-word matches even for common words like of", () => __awaiter(void 0, void 0, void 0, function* () {
        const senderID = new mongoose_1.default.Types.ObjectId();
        ...
        const service = new searchService_1.SearchService(postsModel_1.default, new llmService_1.LlmService());
        const result = yield service.searchPostsAi('give me the posts that contain the word "of"', 1, 10);
        expect(result.source).toBe("fallback");
        expect(result.total).toBe(1);
