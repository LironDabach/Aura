    ...
    return (0, swagger_jsdoc_1.default)({
        definition: {
            ...
            info: {
                ...
                version: "1.0.0",
                description: "REST API documentation for users, posts, comments, likes, uploads, and authentication.",
            },
            servers: [
                {
                    url: serverUrl,
...
const setupSwagger = (app) => {
    ...
    app.use("/api-docs", swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(spec, uiOptions));
};
